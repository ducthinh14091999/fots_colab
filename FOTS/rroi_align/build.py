...
def get_extensions():
    ...
    include_dirs = [extensions_dir,'/usr/local/cuda-11.1/targets/x86_64-linux/include','/usr/local/lib/python3.7/dist-packages/torch/include','/usr/local/lib/python3.7/dist-packages/torch/include/torch/csrc/api/include']
    print(include_dirs)
    ext_modules = [
        extension(
            "rotated_roi",
